...
<body>
      ...
      <header  class="absolute inset-x-0 top-0 z-50 " >
        <nav  class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
            ...
            <div class="hidden lg:flex lg:gap-x-12 ">
                ...
                <a href="/ourwork" class="text-lg font-semibold leading-6 hover:text-red-600 text-white">Our Work</a>
                <a href="/about" class="text-lg font-semibold hover:text-red-600 leading-6 text-white">About Us</a>
            </div>
    ...
    <section id="about" class="min-h-screen bg-[#0f172a] flex items-center justify-center pt-16 md:pt-20 py-30 text-white">
      <div class="container mx-auto px-6 lg:px-20 text-center">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-center mb-16">
              <div class="bg-[#1e293b] p-6 rounded-xl shadow-lg">
                  ...
                  <p class="text-gray-300 text-sm md:text-base">Build real-world applications and solve practical problems guided by industry mentors.</p>
              </div>
              <div class="bg-[#1e293b] p-6 rounded-xl shadow-lg">
                  <h3 class="text-xl md:text-2xl font-semibold text-[#64FFDA] mb-2">Domain Options</h3>
                  <p class="text-gray-300 text-sm md:text-base">Choose between Web Full Stack Development or Electronics based on your passion and goals.</p>
              </div>
              <div class="bg-[#1e293b] p-6 rounded-xl shadow-lg">
                  <h3 class="text-xl md:text-2xl font-semibold text-[#64FFDA] mb-2">Flexible Durations</h3>
                  <p class="text-gray-300 text-sm md:text-base">Intern for 30 days, 45 days, or 6 months. Learn at your pace, earn at your potential.</p>
              </div>
          </div>
  
          <!-- CTA Button -->
          <div>
              <a href="#register" class="inline-block bg-[#64FFDA] text-black font-semibold py-3 px-8 rounded-xl shadow-md hover:bg-[#3de2c2] transition-all duration-300">
          ...
          <section id="durations" class="py-16">
            <div class="container mx-auto px-4 text-center">
              <h3 class="text-3xl font-semibold text-[#64FFDA] mb-10">Choose Your Ideal Internship Duration</h3>
              <p class="text-gray-400 max-w-3xl mx-auto mb-12">
                Select the internship length that fits your learning goals, availability, and career aspirations. Whether you're looking for a quick exposure or deep industry-level training, we’ve got you covered.
              </p>
          
              <div class="flex flex-col md:flex-row justify-center gap-8">
                
                <!-- 30 Days Plan -->
                <div class="bg-[#1C2E4A] p-6 rounded-2xl w-full md:w-1/4 shadow-md text-left">
