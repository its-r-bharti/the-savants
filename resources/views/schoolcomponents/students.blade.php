<div id="students" class="p-4 sm:ml-64">
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Admit School</h3>
                        <p class="mt-4 text-sm text-gray-600">Streamline student admissions and track each step with ease.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Academic Session</h3>
                        <p class="mt-4 text-sm text-gray-600">Easily manage term dates and transition between sessions.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Student Information</h3>
                        <p class="mt-4 text-sm text-gray-600">Maintain and access up-to-date student records effortlessly.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Attendance</h3>
                        <p class="mt-4 text-sm text-gray-600">Automate attendance tracking and provide real-time updates.</p>
                    </div>
