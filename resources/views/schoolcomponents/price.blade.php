                ...
                <div class="p-6 md:py-8 md:px-9">
                    ...
                    <div class="flex items-end mt-5">
                        <div class="flex items-start">
                            ...
                            <p id="personal-price" class="text-6xl font-medium tracking-tight" data-monthly="1500" data-yearly="15000">1500</p>
                        </div>
                ...
                <div class="p-6 md:py-8 md:px-9">
                    ...
                    <ul class="flex flex-col mt-8 space-y-4">
                        ...
                        <li class="inline-flex items-center space-x-2">
                            ...
                            <span class="text-base font-medium text-gray-900"> Full control of your school By management system </span>
                        </li>
                        ...
                        <li class="inline-flex items-center space-x-2">
                            ...
                            <span class="text-base font-medium text-gray-900"> Admin ,accountant & teacher Portal </span>
                        </li>
        ...
        <div class="grid max-w-3xl grid-cols-1 gap-6 mx-auto sm:grid-cols-2 mt-14 md:gap-9">
            ...
            <div class="overflow-hidden bg-transparent border-2 border-gray-200 rounded-md">
                <div class="p-6 md:py-8 md:px-9">
                    ...
                    <button id="open-standard-form" class="inline-flex items-center justify-center w-full px-4 py-3 mt-6 font-semibold text-gray-900 transition-all duration-200 bg-transparent border-2 rounded-full border-fuchsia-600 hover:bg-fuchsia-600 hover:text-white focus:text-white focus:bg-fuchsia-600">
                        Start 30 Days Free Trial
                    </button>
            ...
            <div class="overflow-hidden bg-white border-2 border-transparent rounded-md">
                <div class="p-6 md:py-8 md:px-9">
                    ...
                    <button id="open-professional-form" class="inline-flex items-center justify-center w-full px-4 py-3 mt-6 font-semibold text-white transition-all duration-200 border-2 border-transparent rounded-full bg-gradient-to-r from-fuchsia-600 to-blue-600 hover:opacity-80 focus:opacity-80">
                        Start 30 Days Free Trial
                    </button>
                    <ul class="flex flex-col mt-8 space-y-4">
                        <li class="inline-flex items-center space-x-2">
    ...
    <div id="standard-modal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white p-6 rounded-md">
            ...
            <form id="standard-plan-form">
                ...
                <input type="text" id="name-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your name" required>

                <label for="email-standard" class="block text-sm font-medium text-gray-700 mt-4">Email</label>
                <input type="email" id="email-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your email" required>

                <label for="school-name-standard" class="block text-sm font-medium text-gray-700 mt-4">School Name</label>
                <input type="text" id="school-name-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter school name" required>

                <label for="Phone Number" class="block text-sm font-medium text-gray-700 mt-4">Phone Number</label>
                <input type="number" id="school-name-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter Phone Number" required>

                <label for="template-standard" class="block text-sm font-medium text-gray-700 mt-4">Select Template Id </label>
                <select id="template-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                ...
                <button id="close-standard-modal" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">Close</button>
                <button id="Submit-standard-modal" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">Submit</button>
            </form>
        </div>
    </div>
    ...
    <div id="professional-modal" class="hidden fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white p-6 rounded-md">
            ...
            <form id="professional-plan-form">
                ...
                <input type="text" id="name-professional" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your name" required>

                <label for="email-professional" class="block text-sm font-medium text-gray-700 mt-4">Email</label>
                <input type="email" id="email-professional" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter your email" required>

                <label for="school-name-professional" class="block text-sm font-medium text-gray-700 mt-4">School Name</label>
                <input type="text" id="school-name-professional" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter school name" required>

                <label for="Phone Number" class="block text-sm font-medium text-gray-700 mt-4">Phone Number</label>
                <input type="number" id="school-name-standard" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Enter Phone Number" required>

                <label for="template-professional" class="block text-sm font-medium text-gray-700 mt-4">Select Template Id</label>
                <select id="template-professional" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <option value="template1">Template 1</option>
                    <option value="template2">Template 2</option>
                    <option value="template3">Template 3</option>
                </select>
                ...
                <button id="close-professional-modal" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">Close</button>
                <button id="Submit-professional-modal" class="mt-4 px-4 py-2 bg-blue-600 text-white rounded-md">Submit</button>
            </form>
        </div>
    </div>
</section>
