<div id="exam" class="p-4 sm:ml-64">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            <div class="flex items-center justify-center h-10 md:h-24 rounded-3xl bg-gray-50 dark:bg-gray-800">
                <h2 class="text-xl font-semibold md:text-4xl">
                    <span class="text-red-600">Exams</span>
                </h2> <br>
            </div>
        </div>
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Create Exam</h3>
                        <p class="mt-4 text-sm text-gray-600">Easily design and customize exams to assess student knowledge effectively.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Manage Marks</h3>
                        <p class="mt-4 text-sm text-gray-600">Efficiently track and manage student marks for better academic oversight.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Send Marks by SMS</h3>
                        <p class="mt-4 text-sm text-gray-600">Instantly notify parents with exam results via SMS for improved communication.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Keep Record</h3>
                        <p class="mt-4 text-sm text-gray-600">Maintain comprehensive records of student performance for future reference.</p>
                    </div>
                </div>
            </div>
          </section>
