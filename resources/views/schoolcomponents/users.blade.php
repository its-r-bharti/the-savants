<div id="users" class="p-4 sm:ml-64">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4">
            <div class="flex items-center justify-center h-10 md:h-24 rounded-3xl bg-gray-50 dark:bg-gray-800">
                <h2 class="text-xl font-semibold md:text-4xl">
                    <span class="text-red-600">Users</span>
                </h2>
            </div>
        </div>
            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 text-center sm:grid-cols-2 gap-y-8 lg:grid-cols-4 sm:gap-12">
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Administration</h3>
                        <p class="mt-4 text-sm text-gray-600">Manage school operations efficiently with centralized controls.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Staff</h3>
                        <p class="mt-4 text-sm text-gray-600">Access class schedules, attendance, and grading tools with ease.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Parent</h3>
                        <p class="mt-4 text-sm text-gray-600">Monitor student performance, attendance, and communicate easily.</p>
                    </div>
                    ...
                    <div>
                        ...
                        <h3 class="mt-8 text-lg font-semibold text-black">Student</h3>
                        <p class="mt-4 text-sm text-gray-600">Access class schedules, assignments, and grades instantly.</p>
                    </div>
