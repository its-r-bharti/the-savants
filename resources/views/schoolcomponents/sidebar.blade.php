<div class="flex h-screen">
    ...
    <aside id="default-sidebar"
        class="hidden sm:block sticky top-0 left-0 z-40 w-64 h-full bg-gray-50 dark:bg-gray-800 overflow-y-auto"
        aria-label="Sidebar">
    ...
    <!-- Main Content -->
    <main class="flex-1 bg-white dark:bg-gray-900 p-4 overflow-y-auto">
