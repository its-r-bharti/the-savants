    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p class="text-base leading-relaxed text-gray-600 mt-7">At The Savants, we specialize in tailored services to help businesses, schools, and enterprises thrive in the digital world. Discover how we can help you!</p>
        ...
        <p class="text-sm text-center text-gray-600">© 2024 <a href="https://thesavants.in/">The Savants</a>. All Rights Reserved.</p>
    </div>
</section>
