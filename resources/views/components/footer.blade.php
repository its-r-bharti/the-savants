    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                ...
                <p class="text-base leading-relaxed text-gray-600 mt-7">At The Savants, we specialize in tailored
                    services to help businesses, schools, and enterprises thrive in the digital world. Discover how we
                    can help you!</p>
                ...
                <ul class="flex items-center space-x-3 mt-9">
                    ...
                    <li>
                        <a href="https://www.instagram.com/thesavants.in/" title=""
                            class="flex items-center justify-center text-white transition-all duration-200 bg-gray-800 rounded-full w-7 h-7 hover:bg-blue-600 focus:bg-blue-600">
                            <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                fill="currentColor">
                                <path
                ...
                <form action="#" method="" class="mt-6">
                    <div>
                        ...
                        <input type="email" name="email" id="email" placeholder="Enter your email"
                            class="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white rounded-full  border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                    </div>

                    <button type="submit"
                        class="inline-flex items-center justify-center px-6 py-2 mt-3 font-semibold text-white transition-all duration-200 bg-indigo-500 border-2 border-indigo-500  hover:text-gray-900 hover:bg-gray-50 active:bg-indigo-600 rounded-lg">Subscribe</button>
                </form>
            </div>
        </div>
        ...
        <p class="text-sm text-center text-gray-600">© 2024 <a href="https://thesavants.in/">The Savants</a>. All Rights
            Reserved.</p>
