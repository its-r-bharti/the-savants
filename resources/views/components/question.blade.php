    ...
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl relative">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div
                ...
                <a href="#contactModal"
                    class="block w-[50%] h-10 flex items-center justify-center text-white bg-indigo-500 rounded-3xl border-2 border-indigo-500 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 transition duration-200 mb-4"
