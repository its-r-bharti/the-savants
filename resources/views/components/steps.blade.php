...
<section class="bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 text-gray-900">
...
<br><br><br>
            ...
            <p class="mt-4 text-gray-900">Just three simple steps to unlock your solution hassle-free. Let's make it easy
                for you to get started!</p>
        </div>

        <div class="max-w-5xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-6">
            <!-- Step 1 -->
            <div class="flex flex-col items-center hover:bg-gray-300 transition duration-300 rounded-3xl p-4">
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="mt-2 text-gray-900">Ready to get started? Schedule your service with us today.</p>
                </div>
            </div>
            ...
            <div class="flex flex-col items-center hover:bg-gray-300 transition duration-300 rounded-3xl p-4">
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="mt-2 text-gray-900">Ready to talk? Start your consultation with us now and let's find the
            ...
            <div class="flex flex-col items-center hover:bg-gray-300 transition duration-300 rounded-3xl p-4 ">
                ...
                <div class="text-center mt-4">
                    ...
                    <p class="mt-2 text-gray-900 ">Keep track of your growth effortlessly. Let's measure your progress
                        together.</p>
                </div>
            </div>
        </div>
